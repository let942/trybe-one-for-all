...
CREATE TABLE SpotifyClone.amigos (
...
FOREIGN KEY (user_plan) REFERENCES plan(id)
);
...
VALUES
('Thati', 23, 1, 20191020),
('Cintia', 35, 2, 20171230),
('Bill', 20, 3, 20190605),
('Roger', 45, 4, 20200513),
('Norman', 58, 4, 20170217),
('Patrick', 33, 2,20170106),
('Vivian', 26, 3, 20180105),
('Carol', 19, 3, 20180214),
('Angelina', 42, 2, 20180429),
('Paul', 46, 2, 20170117);
...
INSERT INTO SpotifyClone.album (album_name, artist_id, album_year)
VALUES
('Envious',1,1990 ),
('Exuberant', 1, 1993),
...
INSERT INTO SpotifyClone.music (music_name, time_seconds, album_id)
VALUES
('Soul For Us', 200, 1),
...
INSERT INTO SpotifyClone.artists_following(id_user, id_artist)
VALUES
(1,1),
(1,4),
(1,3),
...
INSERT INTO SpotifyClone.historic(id_user, id_music, time_data)
VALUES
